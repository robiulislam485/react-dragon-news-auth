  ...
  return (
    <div className="flex justify-between items-center">
      ...
      <div className="login flex gap-2 items-center">
        <div className=" ">
          {
            user && user?.email ? <div><img className="h-12 w-12 rounded-full" src={user?.photoURL} alt="" /> <p className="text-lg font-semibold">{user?.displayName}</p></div> :  <img src={userIcon} alt="" />
          }
